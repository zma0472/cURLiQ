/*
 * This is Alexy Tourbin's SQLite extension REGEXP.  It adds the REGEXP
 * operator to the SQLite language.  This uses the Perl Compatible Regular
 * Expressions library libpcre.
 *
 * To use REGEXP in an interactive session:
 *
 * sqlite3> .load /usr/lib/sqlite3/pcre.so
 */
